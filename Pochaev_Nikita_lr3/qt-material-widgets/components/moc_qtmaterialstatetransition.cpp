...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtMaterialStateTransition_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtMaterialStateTransition_t qt_meta_stringdata_QtMaterialStateTransition = {
    {
QT_MOC_LITERAL(0, 0, 25) // "QtMaterialStateTransition"
...
static const uint qt_meta_data_QtMaterialStateTransition[] = {
...
QT_INIT_METAOBJECT const QMetaObject QtMaterialStateTransition::staticMetaObject = { {
    &QAbstractTransition::staticMetaObject,
    qt_meta_stringdata_QtMaterialStateTransition.data,
